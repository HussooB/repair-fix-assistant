...
var QueryBuilder = class {
	static buildFilterConditions(filter, params, paramIndex) {
		...
		for (const [key, value] of Object.entries(filter)) if (typeof value === "object" && value !== null && !Array.isArray(value)) {
			const operators = Object.keys(value);
			const isOperatorObject = operators.some((op) => op.startsWith("$"));
			if (isOperatorObject) for (const [operator, operatorValue] of Object.entries(value)) {

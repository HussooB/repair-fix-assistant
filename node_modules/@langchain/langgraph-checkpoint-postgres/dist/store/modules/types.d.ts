...
//#region src/store/modules/types.d.ts
...
type EmbeddingsFunc = (texts: string[]) => Promise<number[][]>;
type VectorIndexType = "ivfflat" | "hnsw";
...
//#endregion
export { DistanceMetric, Embeddings, EmbeddingsFunc, FilterOperators, HNSWConfig, IVFFlatConfig, IndexConfig, PostgresStoreConfig, PutOptions, SearchItem, SearchOptions, TTLConfig, VectorIndexType };
